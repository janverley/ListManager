...
namespace Lms.View.DataSelection.Pivot
{
  public class DragDropHelper
  {
    ...
    public static readonly DependencyProperty IsBeingDraggedProperty =
      DependencyProperty.RegisterAttached("IsBeingDragged", typeof(bool), typeof(DragDropHelper), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender));

    public static bool GetIsBeingDragged(DependencyObject obj)
    {
      return (bool)obj.GetValue(IsBeingDraggedProperty);
    }
    public static void SetIsBeingDragged(DependencyObject obj, bool value)
    {
    ...
    private void DragSource_PreviewMouseMove(object sender, MouseEventArgs e)
    {
      if (this.draggedData != null)
      {
        ...
        {
          this.sourceItemContainer.SetValue(IsBeingDraggedProperty, true);
    ...
    private void DropTarget_PreviewDrop(object sender, DragEventArgs e)
    {
      ...
      if (draggedItem != null)
      {
        ...
        this.sourceItemContainer.SetValue(IsBeingDraggedProperty, false);

        Keyboard.Focus(this.targetItemsControl);
      ...
      if (IsDropDataTypeAllowed(draggedItem))
      {
        if (targetItemsControlCount > 0)
        {
          ...
          if (this.targetItemContainer != null)
          {
            ...
            this.isInFirstHalf = Utilities.IsInFirstHalf(this.targetItemContainer, positionRelativeToItemContainer, true);
    ...
    private void CreateInsertionAdorner()
    {
      if (this.targetItemContainer != null)
      {
        ...
        this.insertionAdorner = new InsertionAdorner(true, this.isInFirstHalf, this.targetItemContainer, adornerLayer);
      }
    }
